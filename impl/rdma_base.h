...
public:
     ...
     * This method is allowed to be called only once. Further attempts will throw `std::runtime_error`.
     * 
     * @param connections Number of connections between each pair of peers. Default to 1.
     * @param type Type of the connection. Currently, only RC and XRC are supported.
     */
    void connect(int connections = 1, ConnectionType type = ConnectionType::RC);
